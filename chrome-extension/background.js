(() => {
  ...
  var import_webextension_polyfill5 = __toESM(__require("webextension-polyfill"));

  // packages/extension/src/handlers/port.ts
  var import_webextension_polyfill4 = __toESM(__require("webextension-polyfill"));
  ...
  var import_webextension_polyfill2 = __toESM(__require("webextension-polyfill"));
  var Wallet = class {
    constructor(crypto3) {
      this.crypto = crypto3;
    }
  ...
  var import_webextension_polyfill3 = __toESM(__require("webextension-polyfill"));
